...
class FriendService {
  ...
  Future<FriendModel> update(int id, Map<String, dynamic> data) async {
    final res = await _dio.put('${ApiEndpoints.friends}/$id', data: data);
    return FriendModel.fromJson(res.data as Map<String, dynamic>);
  }

  Future<void> delete(int id) => _dio.delete('${ApiEndpoints.friends}/$id');

  Future<FriendModel> settle(int id) async {
