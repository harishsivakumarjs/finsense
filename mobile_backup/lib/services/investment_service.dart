...
class InvestmentService {
  ...
  Future<InvestmentModel> update(int id, Map<String, dynamic> data) async {
    final res = await _dio.put('${ApiEndpoints.investments}/$id', data: data);
    return InvestmentModel.fromJson(res.data as Map<String, dynamic>);
  }

  Future<void> delete(int id) => _dio.delete('${ApiEndpoints.investments}/$id');

  Future<InvestmentModel> updateValue(int id, double value) async {
