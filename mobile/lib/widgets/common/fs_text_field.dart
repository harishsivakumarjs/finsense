...
class FSTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      style: isAmount
          ? GoogleFonts.jetBrainsMono(fontSize: 16, color: c.textPrimary)
          : GoogleFonts.plusJakartaSans(fontSize: 14, color: c.textPrimary),
      decoration: InputDecoration(
        labelText: label,
        hintText: hint,
        prefixText: isAmount ? '₹ ' : null,
        prefixStyle: GoogleFonts.jetBrainsMono(fontSize: 16, color: c.textSecondary),
        suffixIcon: suffix,
        prefixIcon: prefix,
      ),
    );
