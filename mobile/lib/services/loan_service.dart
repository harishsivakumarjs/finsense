...
class LoanService {
  ...
  Future<void> deleteLoan(String id) => _dio.delete('${ApiEndpoints.loans}/$id');
  ...
  Future<CreditCardModel> updateCard(String id, Map<String, dynamic> data) async {
    final res = await _dio.put('${ApiEndpoints.cards}/$id', data: data);
    return CreditCardModel.fromJson(res.data as Map<String, dynamic>);
  }

  Future<void> deleteCard(String id) => _dio.delete('${ApiEndpoints.cards}/$id');
}
